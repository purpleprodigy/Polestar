 ...
 * Asset Versioning.
 *
 * @package     PurpleProdigy\AssetVersioning
...
if ( ! function_exists( 'get_theme_version' ) ) :
	 ...
	 *
	 * When in development/debug, it uses the style.css modification time.
	 * Else, it uses the version number from the stylesheet.
	 *
	 * @since 1.0.0
	 *
	 * @return int|string
...
if ( ! function_exists( 'get_asset_current_version_number' ) ) :
	 ...
	 * This function gets the file's modification time when the
	 * site is in development/debug mode.
	 *
	 * @since 1.0.0
	 *
	 * @param $asset_file
